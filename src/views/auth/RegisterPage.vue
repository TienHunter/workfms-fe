      ...
      >
        ...
        <a-form-item name="email">
          <a-input
            ...
            :placeholder="$t('loginPage.EmailHint')"
          />
        </a-form-item>
        ...
        <a-form-item name="rePassword">
          <a-input-password
            ...
            :placeholder="$t('loginPage.ConfirmPasswordHint')"
          />
        </a-form-item>
        <!-- show error -->
        <a-form-item
        ...
        <!-- Đường dẫn đăng nhập -->
        <a-form-item>
          <span class="w-full flex justify-center gap-1"
            >{{ $t("loginPage.YouHaveAccount")
            }}<a href="/login">{{ $t("loginPage.Login") }}</a></span
          >
        </a-form-item>
